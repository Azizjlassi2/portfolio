...
export function Hero() {
  return <section className="relative min-h-screen flex items-center justify-center px-6 py-20 overflow-hidden bg-zinc-950">
        ...
        <div className="flex flex-col items-start gap-8">
          ...
          <div className="space-y-2">
            ...
            delay: 0.2
              ...
              Ingénieur Web &{' '}
              <span className="text-indigo-400">Intelligence Artificielle</span>
            </motion.h2>
          </div>
          ...
          delay: 0.3
            ...
            Ingénieur logiciel passionné, je conçois des systèmes backend
            robustes et des solutions d’intelligence artificielle exploitant le
            Deep Learning. Mon approche combine architectures scalables, API
            REST performantes et intégration de modèles IA pour bâtir des
            applications fiables et prêtes à la production.
          </motion.p>
          ...
          delay: 0.5
            ...
            <a href="#contact" className="px-8 py-3 bg-white text-zinc-950 font-semibold rounded-lg hover:bg-zinc-200 transition-colors">
              Contact Me
            </a>
            <a href="#projects" className="px-8 py-3 bg-zinc-900 text-white font-semibold rounded-lg border border-zinc-800 hover:bg-zinc-800 transition-colors">
              View Projects
            </a>
          </motion.div>
        </div>
      ...
      delay: 1,
      duration: 1
    }} className="absolute bottom-10 left-1/2 -translate-x-1/2 text-zinc-500 flex flex-col items-center gap-2"></motion.div>
    </section>;
}